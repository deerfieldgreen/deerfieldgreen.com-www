...
A pilot is deemed successful when it reinforces what’s working and/or catalyzes actions around what isn’t. Revenue and financial metrics are important for sure. In the usage model world, the _most_ important thing to learn is why a customer is or isn’t using the product _more_ often over time.
